...
function SettingsDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-[var(--z-modal)] grid place-items-center bg-[var(--color-scrim)] p-[var(--space-4)]">
...
.backdrop { position: absolute; inset: 0; background: var(--color-scrim); }
